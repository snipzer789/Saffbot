...
```
cd existing_repo
git remote add origin https://gitlab.com/youtube-announcements/Saffbot.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/youtube-announcements/Saffbot/-/settings/integrations)
